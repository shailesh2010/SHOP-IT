 ...
 */
public class CategoryDealsAdapter extends RecyclerView.Adapter<CategoryDealsAdapter.DealsViewHolder> {
    Context mContext;
    ...
    public CategoryDealsAdapter(Context context, List<DealHolder> data, onDrawerItemSelected drawerItemSelected) {
        mContext = context;
    ...
    public CategoryDealsAdapter(Context context, List<DealHolder> data) {
        mContext = context;
        inflater = LayoutInflater.from(context);
        mData = data;
        mImageLoader = ApplicationInstance.getInstance().getImageLoader();
